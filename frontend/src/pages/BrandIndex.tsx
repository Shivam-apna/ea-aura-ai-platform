    ...
    <div className="relative min-h-screen">
      ...
      <div className="w-full max-w-[1500px] mx-auto px-6">
        ...
        <PagePromptBar
          ...
          className="mt-4 mb-2"
          initialPrompt="What are the Bounce Rate and Page Views type, Brand, Audience Growth, Engagement Rate, Sentiment Score, Share of Voice, and Impressions of AIM Elevate?"
