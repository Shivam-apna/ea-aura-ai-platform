...
const LOCAL_STORAGE_KEY = "customer_analyzer_charts_cache";
const KPI_KEYS_STORAGE_KEY = "customer_analyzer_kpi_keys_cache";
const METRIC_GROUPS_STORAGE_KEY = "customer_analyzer_metric_groups_cache";
...
const CustomerAnalyzer = () => {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      await generatePDF(kpiSectionRef, chartsSectionRef, "Customer Analyzer", "customer_parsed_summary");
  ...
  const fetchData = async (prompt: string) => { // Modified to accept prompt as argument
    ...
    try {
      ...
      localStorage.setItem("customer_parsed_summary", JSON.stringify(parsed));
